...
//           variant="ghost"
//           size="icon"
//           className={`absolute top-4 left-4 rounded-full p-2 ${isFavorite ? 'text-red-500' : 'text-white'} bg-[#052531]`}
//         >
...
//           className=" w-[40] h-[40]  border-gray-200  bg-gray-100  hover:bg-gray-400 text-[#05222D] rounded-full"
//           asChild
//         >
//           <a href="/properties/1">
...
export function PropertyCard({
  ...
  return (
    <div className="relative w-full max-w-[329px] md:max-w-[403px] h-[560px] rounded-3xl overflow-hidden bg-white border border-[#F5F5F5] hover:shadow-lg transition-shadow duration-300">
      ...
      <div className="p-4">
        <h3 className="text-base font-medium text-gray-800 text-right leading-normal tracking-normal">
          {title}
        </h3>
        <p className="text-sm font-normal text-gray-500 text-right">{subtitle}</p>
        ...
        <div className="flex items-center justify-between mt-4">
          <div className="pt-2">
            <p className="text-sm text-gray-500 text-right">السعر</p>
            <div className="text-2xl flex gap-2 text-blue-600 font-bold">
              {price}
