...
//     <div className="flex items-center shrink-0 md:shrink flex-wrap md:justify-between justify-center">
...
// align-bottom
//   ">       
//     <Image src="/main-page/partners/partner1.svg" alt="Partner 1" width={100} height={100} className="mx-auto" />
//     <Image src="/main-page/partners/partner2.svg" alt="Partner 2" width={100} height={100} className="mx-auto" />
//     <Image src="/main-page/partners/partner3.svg" alt="Partner 3" width={100} height={100} className="mx-auto" />
//     <Image src="/main-page/partners/partner4.svg" alt="Partner 4" width={100} height={100} className="mx-auto" />
//     <Image src="/main-page/partners/partner5.svg" alt="Partner 5" width={100} height={100} className="mx-auto" />
//     <Image src="/main-page/partners/partner6.svg" alt="Partner 6" width={100} height={100} className="mx-auto" />
//     <Image src="/main-page/partners/partner7.svg" alt="Partner 7" width={100} height={100} className="mx-auto" />
//     <Image src="/main-page/partners/partner8.svg" alt="Partner 8" width={100} height={100} className="mx-auto" />
//     <Image src="/main-page/partners/partner9.svg" alt="Partner 9" width={100} height={100} className="mx-auto" />
//     <Image src="/main-page/partners/partner10.svg" alt="Partner 10" width={100} height={100} className="mx-auto" />
//     <Image src="/main-page/partners/partner11.svg" alt="Partner 11" width={100} height={100} className="mx-auto" />
