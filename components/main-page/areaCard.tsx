      ...
      <div className="relative h-full w-full">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-white/70 text-sm">عقار</span>
          </div>
          <div className="opacity-0 transition-all duration-500 group-hover:opacity-100 group-hover:translate-y-0 -translate-y-4">
            <div className="w-8 h-8 flex items-center justify-center bg-white/20 backdrop-blur-md rounded-full border border-white/30 transition-transform duration-300 group-hover:scale-110 group-hover:bg-white">
              <ArrowUpLeft className="h-5 w-5 text-black" />
            </div>
          </div>
        </div>
