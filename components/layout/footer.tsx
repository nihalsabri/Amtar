...
export default function Footer() {
  return (
    <footer className="bg-[#0D1B2A] text-white pt-12 pb-8 mt-[80px]">
      <div className="relative z-10 bg-[#F1F5F9] text-[#052531] rounded-3xl p-6 mx-4 md:mx-8 lg:mx-16 shadow-lg h-auto lg:h-[316px] overflow-visible -mt-30 mb-4 lg:pr-[50px] lg:pl-[115px]">
        <div className="flex flex-col lg:flex-row items-center h-full ">
          
          <div className="flex-shrink-0 w-full lg:w-auto lg:mt-[-150px] order-1 lg:order-2">
            <Image
